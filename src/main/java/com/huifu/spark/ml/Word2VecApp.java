...
public class Word2VecApp {
  ...
  public static void main(String[] args) throws IOException {
    ...
    for (String keyWord : keyWords) {
      findWordSynonyms(keyWord, model);
    }
  }
  ...
  private static Word2VecModel createWord2VecModel() throws IOException {
    ...
    scan.setBatch(5000);
    scan.setStartRow(Bytes.toBytes("00001-cn.babymoney.news-95DDA939AA334F2EE4C2161696D889D3"));
    scan.setStopRow(Bytes.toBytes("00001-cn.com.sina.nmg-94CFBC836560B05458CC34BE85762C30"));
    ...
    Word2Vec word2Vec =
        new Word2Vec().setInputCol("text").setOutputCol("result").setVectorSize(400);
